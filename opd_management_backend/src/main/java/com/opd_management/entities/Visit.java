...
public class Visit {
	...
	public Visit(int id, Patient patient_id, Doctor doctor_id, Date visit_date, String complaints, String diagnosis,
			...
			Date followup_date, Date created_at, Date updated_at) {
		super();
		this.id = id;
		this.patient_id = patient_id;
		this.doctor_id = doctor_id;
	...
	public String toString() {
		return "Visit [id=" + id + ", patient_id=" + patient_id + ", doctor_id=" + doctor_id + ", visit_date="
				+ visit_date + ", complaints=" + complaints + ", diagnosis=" + diagnosis + ", advice=" + advice
				+ ", bp=" + bp + ", pulse=" + pulse + ", saturation=" + saturation + ", temperature=" + temperature
